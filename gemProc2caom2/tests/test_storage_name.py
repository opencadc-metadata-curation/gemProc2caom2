...
def test_storage_name(obs_id_mock):
    ...
    try:
        ...
        assert test_sn.file_uri == f'cadc:GEMINI/{test_f_name}'
        assert test_sn.lineage == f'{test_id}/cadc:GEMINI/{test_f_name}'
        assert test_sn.prev == f'{test_id}.jpg'
        assert test_sn.thumb == f'{test_id}_th.jpg'
        assert test_sn.prev_uri == f'cadc:GEMINI/{test_id}.jpg'
        assert test_sn.thumb_uri == f'cadc:GEMINI/{test_id}_th.jpg'
    finally:
